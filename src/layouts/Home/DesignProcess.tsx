...
export default function DesignProcess() {
  return (
    <div className="bg-[#F2F2F2] pt-8 md:pt-11 pb-10 md:pb-14 px-4 md:px-[50px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-6 gap-x-10">
        {designLists.map((design, index) => (
          <div key={index} className="bg-white pl-6 pt-7 pb-3 pr-4">
            <div className="flex itens-center md: gap-3 gap-5">
              ...
              <div className="flex-1">
                <h5 className="text-app-black text-xl font-saira-bold mb-[10px]">
                  {design.title}
                </h5>
                <p className="text-app-black text-sm">{design.content}</p>
              </div>
            </div>
          </div>
        ))}
