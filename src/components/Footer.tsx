...
import DavidImg from "../assets/images/David.svg";
      ...
      <div className="container mx-auto">
        <div className="flex justify-between flex-col lg:flex-row gap-10">
          <div className="w-full lg:w-3/5">
            ...
            <div className="flex justify-between lg:justify-start items-center md:gap-24 my-4 md:my-6">
              <p>Email</p>
              <p>Twitter</p>
              <p>Phone number</p>
              <p>Read CV</p>
            ...
            <div className="flex justify-center lg:justify-start flex-wrap gap-6 md:gap-8">
